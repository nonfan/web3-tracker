...
export function LogoWithText({ className = '' }: Props) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex items-center">
        <span className="text-xl font-bold text-[var(--text-primary)]">
          Web<span className="text-[#34D399]">3</span>
        </span>
        <span className="text-xl font-bold flex items-baseline ml-1">
          <span className="text-[var(--text-primary)]">Track</span>
          <span className="text-[#34D399]">e</span>
          {/* 小图表图标替代部分字母 */}
          <svg width="14" height="18" viewBox="0 0 14 18" className="mx-[-1px]">
            <rect x="0" y="12" width="3" height="6" fill="#34D399" rx="0.5" />
            <rect x="5" y="7" width="3" height="11" fill="#34D399" rx="0.5" />
            <rect x="10" y="2" width="3" height="16" fill="#34D399" rx="0.5" />
            <path d="M2 10 L6.5 5 L11.5 0" stroke="#34D399" strokeWidth="1.5" strokeLinecap="round" fill="none" />
            <polygon points="11.5,0 14,2 11,3" fill="#34D399" />
          </svg>
